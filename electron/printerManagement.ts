...
export class PrinterManagementService {
   ...
   */
  async getPrinter1AuditLog(fromDate?: string, toDate?: string, limit: number = 100): Promise<Printer1AuditRow[]> {
    try {
   ...
   */
  async getPrinter2AuditLog(fromDate?: string, toDate?: string, limit: number = 100): Promise<Printer2AuditRow[]> {
    try {
