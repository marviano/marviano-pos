...
const SYSTEM_POS_TRANSACTION_COLUMNS = new Set([
  'uuid_id', 'business_id', 'user_id', 'waiter_id', 'shift_uuid', 'payment_method', 'payment_method_id', 'sync_status', 'sync_attempts', 'synced_at', 'last_sync_attempt', 'last_sync_error', 'table_id', 'pickup_method', 'total_amount', 'voucher_discount', 'voucher_type', 'voucher_value', 'voucher_label', 'final_amount', 'mdr_rate_percent', 'mdr_amount', 'net_after_mdr', 'amount_received', 'change_amount', 'status', 'refund_status', 'refund_total', 'last_refunded_at', 'created_at', 'updated_at', 'paid_at', 'contact_id', 'customer_name', 'customer_unit', 'caller_number', 'note', 'bank_name', 'card_number', 'cl_account_id', 'cl_account_name', 'bank_id', 'receipt_number', 'transaction_type', 'checker_printed', 'system_pos_synced_at'
]);
